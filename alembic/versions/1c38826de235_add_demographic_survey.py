...
age_group_enum = sa.Enum('UNDER_18', 'UNDER_25', 'UNDER_35', 'UNDER_45', 'UNDER_55', 'UNDER_65', 'OVER_65', name='agegroup')
programming_experience_enum = sa.Enum('UNDER_1YR', 'UNDER_3YR', 'UNDER_6YR', 'UNDER_10YR', 'UNDER_20YR', 'OVER_20YR', name='programmingexperience')
...
def upgrade():
    ...
    sa.Column('programming_experience', programming_experience_enum, nullable=True),
...
def downgrade():
    ...
    programming_experience_enum.drop(op.get_bind())
    # ### end Alembic commands ###
